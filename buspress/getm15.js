...
var sql = 'select  distinct ' + "\"" + cat + "\"" + ',bank,address,zip,phone, author_first_name, author_last_name,author_phone,author_email from ' + tbl + ' order by bank, id desc';

//var sql = 'select  distinct ' + "\"" + cat + "\"" + ',bank,address,zip,phone,exec_first_name,exec_last_name, exec_title, author_first_name, author_last_name,author_phone,author_email from ' + tbl + ' order by bank, id desc';
