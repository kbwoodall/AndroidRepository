...
var sql = 'select  distinct ' + "\"" + cat + "\"" + ',group_name,address,zip,phone, author_first_name, author_last_name,author_phone,author_email from ' + tbl + ' order by group_name, id desc';

//var sql = 'select  distinct ' + "\"" + cat + "\"" + ',group_name,address,zip,phone,exec_first_name,exec_last_name, exec_title, author_first_name, author_last_name,author_phone,author_email from ' + tbl + ' order by group_name, id desc';
