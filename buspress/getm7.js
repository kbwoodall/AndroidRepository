...
var sql = 'select  distinct ' + "\"" + cat + "\"" + ',school_name,address,zip,phone, author_first_name, author_last_name,author_phone,author_email from ' + tbl + ' order by school_name, id desc';
