...
var sql = 'select distinct ' + "\"" + cat + "\"" + ',firm_name,address,zip,phone, author_first_name, author_last_name,author_phone,author_email from ' + tbl + ' order by firm_name, id desc';
